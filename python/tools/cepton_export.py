...
- Jenny's command to only convert for the first second
    python3 cepton_export.py --capture_path [ ]  --format CSV --duration 00:00:01 [ ]   
- To convert all the frames in the input pcap
   python3 cepton_export.py --capture_path [ ]  --format CSV --duration -1 [ ]   
"""
